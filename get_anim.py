...
WEEK_ID = 1
GAME_ID = 2018090600
PLAY_ID = [75,1546,1568,2474,3279,3181]
...
for p in PLAY_ID:
    ...
    track_play = nfl.get_track_play(track_game,p)
    ...
    play_gif = nfl.animate_play(p,home_coord,away_coord,football_coord,event_game)

    print("Saving animation")
    play_gif.save(f"animate_play/play_{GAME_ID}_{p}.mp4",writer='ffmpeg')